<template>
    <div class="box">
        <a-spin :spinning="spinning">
            <a-row class="planTitle">新建任务</a-row>
            ...
            <a-form layout="inline" :form="form">
                ...
                <!-- <a-row :gutter="24" class="formRow">
                    <a-col :md="12" :sm="8">
                        <a-form-item label="子系统任务" :label-col="labelCol" :wrapper-col="wrapperCol">
                            <a-select @change="onChangeSelect" v-decorator="['pythonParams']">
                                <a-select-option v-for="(item,ind) in systemTask" :key="ind" :value="item.id">{{item.systemName}}</a-select-option>
                            </a-select>
                        </a-form-item>
                    </a-col>
                </a-row>
                <a-row :gutter="24" class="formRow">
                    <div style="width:90%;margin:0 auto;border:1px solid #ccc;border-radius:4px">
                        <div class="makesystem">
                            <span>爬虫系统A配置:</span>
                            <div>
                                <a-button @click="addSystems" type="default">添加参数</a-button>
                                <a-button slot="enterButton">删除</a-button>
                            </div>
                        </div>
                        <div>
                            <a-row :gutter="24" class="formRow" v-for="(item,ind) in addSystem" :key="ind">
                                <a-col :md="8" :sm="8">
                                    <a-form-item label="爬虫关键词" :label-col="{ span: 9 }" :wrapper-col="{ span: 12 }">
                                        <a-input placeholder="请输入..." v-decorator="[ 'systemWord']"></a-input>
                                    </a-form-item>
                                </a-col>
                                <a-col :md="8" :sm="8">
                                    <a-form-item label="爬虫值" :label-col="{ span: 9 }" :wrapper-col="{ span: 12 }">
                                        <a-input placeholder="请输入..." v-decorator="[ 'systemVal']"></a-input>
                                    </a-form-item>
                                </a-col>
                                <a-col :md="8" :sm="8">
                                    <a-button @click="delSystem(ind)">删除</a-button>
                                </a-col>
                            </a-row>
                        </div>
                    </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            delSystem(id) {
                // this.addSystem.map((item,ind) => {
                //     if(item.id === id) {
                //         if(id) {
                //             let xxx = delete this.addSystem[id]
                //         }
                //     }
                // })
            },
