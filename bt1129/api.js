...
const getHitShow = (params) => getAction('/nmmonitor-server-moduls-elasticsearch/elasticsearch/getHitShow',params);
const getHitShowContent = (params) => getAction('/nmmonitor-server-moduls-elasticsearch/elasticsearch/getHitShowContent',params);
